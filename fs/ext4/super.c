...
#ifdef CONFIG_EXT4_HUAWEI_READ_ONLY_RECOVERY
{
	...
	* if flag equal to 0, this phone boot not caused by ext4_handle_error, so reboot as reason mountfail.
	* if flag equal to 1, this phone boot caused by mountfail, so not reboot again.
	*/
